...
def writeStartSwitchAndInternalBX(module,mem,extraports=False, delay = 0):
    ...
    #FIXMESpecial case as the PC will generte the start signal for the MP in the split project
    if (mtype != "VMSMER" ) :
    ...
    #FIXME Hack for PC and VMSMER
        if mtype == "PC" :
            startsignal_parameter_list +="        DELAY           => 110,\n"
        elif mtype == "VMSMER" :
            startsignal_parameter_list +="        DELAY           => 90,\n"
        else :
    ...
    #FIXME Hack for PC
    if mtype == "PC" :
        int_ctrl_func += "      done  => "+mtype+"_start,\n"
    else:
